...
<form action="" method="GET" class="form-inline" role="form">
    ...
    <span> 
    <a href="{{route('color.create')}}" class ="btn btn-success glyphicon glyphicon-plus" ></a>
    </span>
</form>
    ...
    <tbody>
        ...
        <td>{{$data->id}}</td>
            ...
            <form action="{{route('color.destroy',$data->id)}}" method="POST">
                    ...
                    <a href="{{route('color.edit',$data->id)}}" class="btn btn btn-primary glyphicon glyphicon-pencil"></a>
